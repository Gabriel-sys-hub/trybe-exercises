...
SELECT mov.title, b.international_sales
...
SELECT b.title, b.director, b.year, b.length_minutes, mov.name, mov.location
FROM Pixar.Theater AS mov
LEFT JOIN Pixar.Movies AS b
ON mov.id = b.theater_id
ORDER BY mov.name;
