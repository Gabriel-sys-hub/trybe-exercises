...
SELECT client.first_name, client.email, client.address_id, address.district, address.address
FROM sakila.customer AS client
INNER JOIN sakila.address AS address
ON client.address_id = address.address_id
WHERE address.district = 'California'
AND client.first_name LIKE '%rene%'
