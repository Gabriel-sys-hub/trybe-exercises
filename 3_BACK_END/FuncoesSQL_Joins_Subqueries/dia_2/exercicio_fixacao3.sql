...
(SELECT first_name FROM sakila.actor ORDER BY first_name DESC
LIMIT 5)
UNION
...
(SELECT first_name, last_name FROM sakila.actor ORDER BY first_name ASC LIMIT 100)
UNION
(SELECT first_name, last_name FROM sakila.customer ORDER BY first_name ASC LIMIT 100)
LIMIT 15
OFFSET 60;
