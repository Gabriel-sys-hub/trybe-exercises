...
SELECT 220 DIV 12; -- 18.3
SELECT 18 * 12; -- resta 4 pra 220;
...
SELECT ROUND(7 + (RAND() * 8));

-- Monte uma query que exiba o valor arredondado de 15.7515971 com uma precisão de 5 casas decimais.

SELECT ROUND(15.7515971, 5); -- Segundo parametro arredonda a quantidade de casas decimais, caso não passe, ele arredonda o valor para cima ou para baixo;
